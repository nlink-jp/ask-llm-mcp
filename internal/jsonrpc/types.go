// Package jsonrpc defines JSON-RPC 2.0 message types used over the MCP
// stdio channel.
//
...
// no ID (IsNotification reports true).
type Request struct {
...
// IsNotification reports whether the request is a notification (no
// response expected).
